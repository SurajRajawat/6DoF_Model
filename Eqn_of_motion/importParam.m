...
% MAV.mass = 13.5; MAV.Jx   = 0.8244; MAV.Jy   = 1.135; MAV.Jz   = 1.759;
% MAV.Jxz  = 0.1204; MAV.Jxz  = 0;

% % initial conditions MAV.pn0    = 0;  % initial North MAVosition MAV.pe0
% = 0;  % initial East MAVosition MAV.pd0    = 0;  % initial Down
% MAVosition (negative altitude) MAV.u0     = 0;  % initial velocity along
% body x-axis MAV.v0     = 0;  % initial velocity along body y-axis MAV.w0
% = 0;  % initial velocity along body z-axis MAV.phi0   = 0;  % initial
% roll angle MAV.theta0 = 0;  % initial MAVitch angle MAV.psi0   = 0;  %
% initial yaw angle MAV.p0     = 0;  % initial body frame roll rate MAV.q0
% = 0;  % initial body frame MAVitch rate MAV.r0     = 0;  % initial body
% frame yaw rate
...
% Create a new directory 'tools' and write equations for quaternions and all. 
...
% wind parameters
MAV.wind_e  = 0;  % initial wind speed eastward
MAV.wind_d  = 0;  % initial wind speed downwards
MAV.wind_n  = 0;  % initial wind speed northward
